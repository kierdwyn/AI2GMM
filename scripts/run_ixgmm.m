...
fpath = 'D:\Google Drive\Studies\Research\data\flight_line\'; % folder containing the data set
name = 'FlowCapIII_LA_4_SI_2_formated'; % file name of the data set without extension
...
max_sweep = 10;    % # of sweeps after adding test data.
init_sweep = 40;   % # of training sweeps.
burnin = 0;       % # of burnin sweeps we don't take sample.
sample = 10;        % # of samples we take between burinin+1:max_sweep.
max_n_c = 300;      % maximum # of clusters allowed.
ins = 1;            % A list of training classes.
train_ratio = 1;    % 1/5 (20%) training data from trainig classes.
...
c1 = 0.1; c2 = d+2;
beta0 = d*2; alpha0 = beta0*kappa0 + 1;
beta1 = d*2; alpha1 = beta1*kappa1 + 1;
priors{3} = [mu0;sigma0/(c2-d)]; specs{3} = [ 0 0 0 [0 0] 0 0]; % ratio, prior, train, kap1>kap0, kap1<x*kap0, all in H, table
